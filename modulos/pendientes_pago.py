...
def pendientes_pago():
    ...
    try:
        ...
        socio_sel = st.selectbox("Selecciona socio", resumen["MOSTRAR"].tolist(), key="sel_pago")
        ...
        st.text_area("Mensaje WhatsApp", value=texto, height=500, key=f"txt_pago_{eh}_{len(detalle)}")
