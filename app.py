...
def mostrar_inicio() -> None:
    st.markdown(
        ...
        <div style="padding: 30px; border-radius: 18px; background: linear-gradient(135deg, #0033A0, #00AEEF); color: white;">
            ...
            <p style="font-size: 18px;">Seguimiento de agenda técnica, pendientes de instalación y suspendidas.</p>
...
def main() -> None:
    ...
    modulo = st.sidebar.radio(
        "Selecciona módulo",
        ["Inicio", "Agenda Técnica", "Pendientes de Instalación", "Suspendidas"],
